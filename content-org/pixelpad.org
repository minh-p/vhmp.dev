...
:ID:       429f323b-7019-4141-b52f-a9ce10ad346b
:END:
** What is pixelPAD?
...
*** Coach Strategy
Creation of a text box is heavy in instructions. The @@hugo:[best for engagement]({{< relref "/programming/teaching/teaching-programming/#best-for-engagement" >}})@@ strategy should be used.
*** Guide and Solution
...
#+end_details
** Related
These beginner concepts reference the @@hugo:[programming fundamentals roadmap]({{< relref "/programming/teaching/programming-fundamentals/#roadmap" >}})@@.

For insights about my teaching approach, check out my @@hugo:[teaching philosophy page]({{< relref "/programming/teaching/teaching-programming" >}})@@.
* Space Obstacles Avoidance (WIP)
:PROPERTIES:
:EXPORT_FILE_NAME: space-obstacles-avoidance
:END:

** Space Obstacles Avoidance
...
#+attr_shortcode: :title Solution - Game Plan, Learning List
#+begin_details
...
#+attr_shortcode: :title Solutions - Concepts Needed Example
#+begin_details
...
If you have already gone through the activities, or do not feel like repeating them. Check out the relevant document page on this topic at [[https://pixelpad.io/docs/?c=sprites][pixelpad.io/docs]].

First, create the =class= for the =sprite object= and add a =image= for the =sprite object=.

#+hugo_paired_shortcodes: %details
#+attr_shortcode: :title Solution - Sprite Creation
#+begin_details
...
#+attr_html: :filename Player Start
#+BEGIN_SRC python
...
1. [[https://pixelpad.io/docs/?c=objects][Objects]] - Sprite manipulation, position, etc.
2. [[https://pixelpad.io/docs/?c=input][Inputs]] - Listening to key inputs; notice that it's used in =loop= and not =start= (understand why this is the case).
3. [[/programming/teaching/programming-fundamentals/conditionals/][Conditionals]] - Read this page on if-statements.

#+hugo_paired_shortcodes: %details tabs %tab

#+attr_shortcode: :title Solution - WASD
#+begin_details
*Non-exclusive movements* - Option 1

#+attr_html: :filename Player Loop
#+BEGIN_SRC python
    if key_is_pressed("a"):
        self.x = self.x - 10
    if key_is_pressed("d"):
