...
When a student begins learning C++, I expect that he had developed the discipline of knowing all of the @@hugo:[programming fundamentals]({{< relref "/programming/teaching/programming-fundamentals" >}})@@ I have listed. Additionally, they should have some basic experience with Object-Orientated Programming.
...
** 1. Project Setup
*** Replit
There isn't any web platform that can host C++ that I know of besides Replit. The best tools are the tools that you own. Most of my students at [[https://https://www.thecoderschool.com/locations/irvine/][TheCoderSchool, Irvine]] use a chromebook, so we opt to use Replit.
...
New Replit projects uses nix for package management. So don't reuse an old Replit application. The specifics is recorded in the Replit App Configuration or the [[https://docs.replit.com/features/project-setup/configuration][Advanced Configuration page]].
...
#+attr_html: :filename Stack.hpp
#+BEGIN_SRC cpp
  class Stack {
  };
#+END_SRC

#+attr_html: :filename stack.cpp
#+BEGIN_SRC cpp
  #include "Stack.hpp"
...
The adjective =contiguous= describes a collection whose elements' memory addresses are next to each other. Contiguous memory is preferred by your CPU because of efficient cache operations \to a concept called =cache locality= which you can further research on.
#+END_QUOTE
...
#+attr_shortcode: :title Solution - Push
#+begin_details
#+attr_html: :filename Stack.cpp
#+BEGIN_SRC cpp
...
#+attr_shortcode: :title Solution - Pop
#+begin_details
#+attr_html: :filename Stack.cpp
#+BEGIN_SRC cpp
  int Stack::pop() {
...
#+attr_shortcode: :title Solution - Resize
#+begin_details
#+attr_html: :filename Stack.cpp
#+BEGIN_SRC cpp
  void Stack::resize() {
