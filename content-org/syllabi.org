#+hugo_base_dir: ../
#+hugo_section: programming/teaching/syllabi
* Syllabi
:PROPERTIES:
...
This section includes all the syllabi of the programming classes I teach.

#+hugo_paired_shortcodes: button

#+attr_shortcode: :href /programming/teaching/syllabi/tcs-syllabus
#+begin_button
TheCoderSchool
#+end_button
* TheCoderSchool
:PROPERTIES:
:EXPORT_FILE_NAME: tcs-syllabus
:END:
#+hugo_paired_shortcodes: %steps
** Intro
This syllabus was created with the assistance of [[https://openai.com/index/gpt-5-6/][OpenAI GPT-5.6 Sol]]. This is not an official syllabus of the franchised TheCoderSchool location in Irvine. It is an informal guide showing students and parents what working with *Coach Huy* as a coding coach may look like.
...
#+begin_steps
1. Identify what the student is trying to create.
2. Search documentation for the relevant feature.
3. Read the documentation and identify useful functions, classes, or variables.
4. Look at examples.
5. Form questions about confusing parts.
6. Watch Coach Huy demonstrate the mechanic when needed.
7. Recreate the mechanic independently.
8. Complete a short debrief afterward.
#+end_steps
...
3. Identify useful functions or classes.
4. Read function signatures.
5. Identify required and optional arguments.
6. Look at examples.
7. Try the feature.
8. Form specific questions about anything that remains confusing.
#+end_steps
...
#+begin_quote
[!TIP]
/"I found the =text= function and understand its first argument, but I do not understand what the x and y arguments control."/
#+end_quote
